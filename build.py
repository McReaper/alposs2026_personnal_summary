    ...
    <div class="synth-body">
      ...
      <div class="synth-cards">
        ...
        <div class="synth-card">
          ...
          <div class="synth-card-body">Matrix/Element + ProConnect couvre un vide réel. Opportunité de conseil et de déploiement pour Kaizen accompagnant les collectivités — avant que le marché soit adressé par les grands comptes.</div>
        ...
        <div class="synth-card">
          ...
          <div class="synth-card-body">Le Cyber Resilience Act impose une traçabilité de la chaîne logicielle (SBOM, correctifs, divulgation). Kaizen, qui intervient sur les systèmes de ses clients, est directement concernée — besoin d'audit et de conseil dès maintenant.</div>
